    ...
    <nav className="bg-[#E8DFCA] border border-gray-200 shadow-md dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2">
          ...
          <button onClick={()=>navigate('/login')} className="bg-gray-700 text-white py-1.5 px-3 rounded font-semibold ml-4">Login</button>
          <div
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border text-gray-800 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
